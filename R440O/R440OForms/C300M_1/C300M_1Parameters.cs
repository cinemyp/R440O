...
{
    public class C300M_1Parameters
    {
        private static C300M_1Parameters instance;
        public static C300M_1Parameters getInstance()
        {
            if (instance == null)
        ...
        /// 9 - 480.
        /// </summary>
        public C300M_1КнопкиВидРаботы КнопкиВидРаботы = new C300M_1КнопкиВидРаботы();
        ...
        /// 9 - -12.6.
        /// </summary>
        public C300M_1КнопкиКонтрольРежима КнопкиКонтрольРежима = new C300M_1КнопкиКонтрольРежима();

...
namespace R440O.R440OForms.K02M_01Inside
{
    ...
    public partial class K02M_01InsideForm : Form
    {
        ...
        {
            ТумблерБ5.BackgroundImage = K02M_01InsideParameters.getInstance().ТумблерБ5
        ...
        {
            K02M_01InsideParameters.getInstance().ParameterChanged += RefreshFormElements;
        ...
        {
            K02M_01InsideParameters.getInstance().ТумблерБ5 = !K02M_01InsideParameters.getInstance().ТумблерБ5;
        }
    }
}
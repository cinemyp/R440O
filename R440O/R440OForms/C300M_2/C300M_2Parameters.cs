    ...
    public static class C300M_2Parameters
    {
        ...
        public static bool Включен
        {
            get
            {
                return НеполноеВключение &&
                       ((ТумблерУправление && N15Parameters.getInstance().ТумблерЦ300М2) || (!ТумблерУправление && КнопкиПитание));
            }
        }
        ...
        public static bool ТумблерУправление
        {
            ...
            set
            {
                ...
                КнопкиПитание = (!value && N15Parameters.getInstance().ТумблерЦ300М2);
            }
        }
        ...
        public static BroadcastSignal ВходящийСигнал
        {
            get
            {
                return Включен ? A306Parameters.getInstance().ВыходнойСигнал2 : new BroadcastSignal();
            }
        }

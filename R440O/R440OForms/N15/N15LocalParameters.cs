    ...
    public static class N15LocalParameters
    {
        ...
        public static bool локТумблерАнтЭкв
        {
            ...
            set
            {
                ...
                N15Parameters.ТумблерАнтЭкв = value;OnParameterChanged();
            }
        }
        ...
        public static bool локКнопкаН13_1
        {
            ...
            set
            {
                ...
                if (value) N15Parameters.КнопкаН13 = 1;OnParameterChanged();
            }
        }
        ...
        public static bool локКнопкаН13_2
        {
            ...
            set
            {
                ...
                if (value) N15Parameters.КнопкаН13 = 2;OnParameterChanged();
            }
        }
        ...
        public static bool локКнопкаН13_12
        {
            ...
            set
            {
                ...
                if (value) N15Parameters.КнопкаН13 = 3;OnParameterChanged();
            }
        }
        #endregion

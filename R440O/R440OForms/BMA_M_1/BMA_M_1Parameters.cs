    ...
    public class BMA_M_1Parameters
    {
        ...
        public Chanel СигналКанал1
        {
            get
            {
                ...
                if (N18_MParameters.getInstance().Проверить_комутацию(ГнездаН18.КоммутацияПрм_Канал1_Б11, ГнездаН18.КоммутацияПрм_Канал1_БМА1) &&
        ...
        public Chanel СигналКанал2
        {
            get
            {
                ...
                if (N18_MParameters.getInstance().Проверить_комутацию(ГнездаН18.КоммутацияПрм_Канал2_Б11, ГнездаН18.КоммутацияПрм_Канал1_БМА1)
                    && B1_1Parameters.getInstance().ВыходнойСигнал != null)
                {
        ...
        public Chanel СигналКанал3
        {
            get
            {
                ...
                if (N18_MParameters.getInstance().Проверить_комутацию(ГнездаН18.КоммутацияПрм_Канал3_Б11, ГнездаН18.КоммутацияПрм_Канал1_БМА1)
                    && B1_1Parameters.getInstance().ВыходнойСигнал != null)
                {
        ...
        public Chanel СигналКулона
        {
            ...
            {
                // Получение сингала по каналу 1 с Б1 через Н18
                if (N18_MParameters.getInstance().Проверить_комутацию(ГнездаН18.КоммутацияПрм_Канал1_К12, ГнездаН18.КоммутацияПрм_Канал1_БМА1) &&
        ...
        public Chanel СигналЦ3001
        {
            ...
            {
                // Получение сингала по каналу 1 с Б1 через Н18
                if (N18_MParameters.getInstance().Проверить_комутацию(ГнездаН18.Контроль_Прм_Тлф1, ГнездаН18.КоммутацияПрм_Канал1_БМА1) &&

...
{
    public class C300M_3Parameters
    {
        private static C300M_3Parameters instance;
        public static C300M_3Parameters getInstance()
        {
            if (instance == null)
                instance = new C300M_3Parameters();
            return instance;
        }
        ...
        public bool Включен
        {
            get
            {
                return НеполноеВключение &&
                       ((ТумблерУправление && N15Parameters.getInstance().ТумблерЦ300М3) || (!ТумблерУправление && КнопкиПитание));
            }
        }
        ...
        /// 9 - 480.
        /// </summary>
        public C300M_3КнопкиВидРаботы КнопкиВидРаботы = new C300M_3КнопкиВидРаботы();
        ...
        /// 9 - -12.6.
        /// </summary>
        public C300M_3КнопкиКонтрольРежима КнопкиКонтрольРежима = new C300M_3КнопкиКонтрольРежима();
        ...
        public bool ТумблерУправление
        {
            ...
            set
            {
                ...
                КнопкиПитание = (!value && N15Parameters.getInstance().ТумблерЦ300М3);
            }
        }
        ...
        public BroadcastSignal ВходящийСигнал
        {
            get
            {
                return Включен ? A306Parameters.getInstance().ВыходнойСигнал3 : new BroadcastSignal();
            }
        }
        ...
        public void ResetParameters()
        {
            ...
            УправлениеПоиском();
            C300PM_3Parameters.getInstance().ResetParameters();
            OnParameterChanged();
        }
